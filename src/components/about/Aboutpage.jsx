...
const Aboutpage = () => {
  ...
  return (
    ...
    <>
<section className="py-5 bg-gray-100 bg-opacity-40" id="about">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      ...
      <div className="text-center md:text-left">
        ...
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          <h3 className="font-bold mb-4 text-blue-600">Location</h3>
        ...
        {/* Amenities */}
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          <h3 className="font-bold mb-4 text-blue-600">Amenities</h3>
          <p className="text-gray-600 mb-6 calligraph">
        ...
        {/* Rooms & Accommodation */}
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          <h3 className="font-bold mb-4 text-blue-600">Rooms & Accommodation</h3>
          <p className="text-gray-600 mb-6 calligraph">
        ...
        {/* Conferencing */}
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          <h3 className="font-bold mb-4 text-blue-600">Conferencing</h3> 
          <p className="text-gray-600 mb-6 calligraph">
        ...
        <div className="text-center md:text-left flex flex-col items-center md:items-start">
          <h3 className="font-bold mb-4 text-blue-600">Restaurant and Garden Bar</h3>
